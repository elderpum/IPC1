...
public class CancelarPago extends JFrame{
    ...
    public CancelarPago(){
        ...
        this.eliminar.addActionListener(new ActionListener() {
         @Override
         public void actionPerformed(ActionEvent arg0) {
             Cancelar_Pago cancelarpago;
             idremesa = id.getText();
             fechapagartext = fecha.getText();
             usuariopagar = usuario.getText();
             motivopagar = motivo.getText();
             cancelarpago = new Cancelar_Pago(idremesa, fechapagartext, usuariopagar, motivopagar);
             if (Cancelar_Pago.agregarCancelarPago(cancelarpago) == true) {
