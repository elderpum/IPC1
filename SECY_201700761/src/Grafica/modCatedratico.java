 ...
 * @author Elder
 */
public class modCatedratico extends javax.swing.JFrame {

    /**
     * Creates new form modCatedratico
     */
    public modCatedratico() {
        initComponents();
    }
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        ...
        if (x == JOptionPane.YES_OPTION) {
            try{
                Listas.catedratico.editar(txtregistro.getText(), txtnombre.getText(), txtdireccion.getText(), txtcorreo.getText(), txtcontrasenia.getText());
                btncancelar.setEnabled(false);
                btnmodificar.setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modCatedratico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modCatedratico().setVisible(true);
            }
        });
    }
